...
import { CombineFinishChunkStream } from '$$/patches/cursor-compatible'
...
describe('CombineFinishChunkStream', () => {
  it('should process stream from log file', async () => {
    const inputEntries = await loadChunksFromLogFile(__dirname, "CombineFinishChunkStream.20250828164422336.jsonl")
